...
def banner():
	...
	art = r'''
    ____                  _                                  
   / __ \ _ __ ___  _   _| |__   __ ___   ____ _ _ __  _ __  
  / / _` | '_ ` _ \| | | | '_ \ / _` \ \ / / _` | '_ \| '_ \ 
 | | (_| | | | | | | |_| | | | | (_| |\ V / (_| | | | | | | |
  \ \__,_|_| |_| |_|\__,_|_| |_|\__,_| \_/ \__,_|_| |_|_| |_|
   \____/                                                    '''
	utils.print(f'{G}{art}{W}\n')
	utils.print(f'{G}[>] {C}Created By   : {W}@muhavan')
	utils.print(f'{G} |---> {C}Twitter   : {W}https://twitter.com/muhavann')
...
'''
				...
				gview_url = f'{G}[+] {C}Street View : {W}https://www.google.com/maps/@?api=1&map_action=pano&viewpoint={var_lat.strip(" deg")},{var_lon.strip(" deg")}&cbll={var_lat.strip(" deg")},{var_lon.strip(" deg")}&cbp=12,0,,0,0'
				gmaps_json = {'url': f'https://www.google.com/maps/place/{var_lat.strip(" deg")}+{var_lon.strip(" deg")}'}
				utils.print(gmaps_url)
				utils.print(gview_url)
